    ...
    public class Cyberport : IWebsite
    {
        ...
        public string GetProductUrl(Videocard card)
        {
            return card switch
            {
                ...
                Videocard.RX6900XT => "https://www.cyberport.de/pc-und-zubehoer/komponenten/grafikkarten/amd-fuer-gaming.html?productsPerPage=50&sort=popularity&2E_Grafikchip=AMD%20RX%206900&page=1&stockLevelStatus=IMMEDIATELY",
                _ => Url,
            };
        }
